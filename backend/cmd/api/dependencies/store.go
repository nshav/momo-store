	...
	packs := []dumplings.Product{
		{
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/1.jpeg",
		},
		{
			ID:          2,
			Name:        "Хинкали",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/2.jpeg",
		},
		{
			ID:          3,
			Name:        "Манты",
			...
			Price:       2.75,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/3.jpeg",
		},
		{
			ID:          4,
			Name:        "Буузы",
			...
			Price:       4.00,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/4.jpg",
		},
		{
			ID:          5,
			Name:        "Цзяоцзы",
			...
			Price:       7.25,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/5.jpeg",
		},
		{
			ID:          6,
			Name:        "Гедза",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/6.jpg",
		},
		{
			ID:          7,
			Name:        "Дим-самы",
			Description: "С уткой",
			Price:       2.65,
			Image:       "https://storage.yandexcloud.net/momo-store-wallarm/7.jpg",
		},
		{
			ID:          8,
			Name:        "Момо",
